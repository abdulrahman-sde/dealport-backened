...
import { getCouponsQuerySchema, createCouponSchema, updateCouponSchema, } from "../../utils/validators/coupon.validator.js";
...
export const bulkDeleteCoupons = async (req, res) => {
    ...
    res.json(successResponse({ deleted: deletedCount }, `${deletedCount} coupons deleted`));
};
