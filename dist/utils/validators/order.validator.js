...
const objectIdRule = (val) => /^[0-9a-fA-F]{24}$/.test(val);
...
export const paymentMethodSchema = enumField(["CREDIT_CARD", "DEBIT_CARD", "PAYPAL", "BANK_TRANSFER", "CASH_ON_DELIVERY"], "Payment Method");
...
export const parseCreateOrderInput = (input) => createOrderInputSchema.parse(input);
export const getOrdersQuerySchema = paginationSchema.extend({
    ...
    fulfillmentStatus: enumField(["PENDING", "PROCESSING", "SHIPPED", "DELIVERED", "CANCELED"], "Fulfillment Status").optional(),
    paymentStatus: enumField(["PENDING", "COMPLETED", "FAILED", "REFUNDED"], "Payment Status").optional(),
    startDate: z.string().datetime().optional(),
    endDate: z.string().datetime().optional(),
    customerId: z.string().optional(),
    sortBy: enumField(["createdAt", "totalAmount", "orderNumber"], "Sort By").default("createdAt"),
