...
import { formatCustomerOverviewMetrics, formatReportMetrics, } from "../utils/analytics.utils.js";
export const analyticsService = {
    async getTwoWeekStats() {
        ...
        const [thisWeekOrders, previousWeekOrders, thisWeekCustomers, previousWeekCustomers, thisWeekTransactions, previousWeekTransactions, thisWeekProducts, previousWeekProducts,] = await Promise.all([
